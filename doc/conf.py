...
htmlhelp_basename = 'signac-dashboarddoc'
...
latex_documents = [
    (master_doc, 'signac-dashboard.tex', 'signac-dashboard Documentation',
     'Bradley Dice', 'manual'),
]
...
man_pages = [
    (master_doc, 'signac-dashboard', 'signac-dashboard Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'signac-dashboard', 'signac-dashboard Documentation',
     author, 'signac-dashboard',
     'Data visualization based on signac framework', 'Miscellaneous'),
]
